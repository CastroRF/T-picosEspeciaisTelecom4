...
Fc = 60e9; % Carrier frequency in Hz
...
Dis2D = 50:50:500; % Horizontal BS-UE distance in meters
...
% Shadow fading
ShadowFadingFlag = 1; % 0 - not included, 1 - included

% Oxygen absorption
OxygenAbsorptionFlag = 1; % 0 - not included, 1 - included
...
figure();title('Capacidade média do canal no modelo CDL-A');
plot(Dis2D,AveCapacity,'-g','LineWidth',2.0,'MarkerSize',8.0);
xlabel('BS-UE Distancia Horizontal (Metros)');
ylabel('Variação da Capacidade (Mbps)');
grid on;
